...
# ──────────────────────────────────────────────────────────────────────────────
#  Path and Icon utilities
# ──────────────────────────────────────────────────────────────────────────────

def resolve_path(relative_path: str) -> str:
    """Helper to resolve paths correctly in both development and PyInstaller environments."""
    import sys
...
def setup_enter_nav(dialog, widgets, accept_callback=None):
    ...
    """
    accept_fn = accept_callback or getattr(dialog, "_accept", None) or getattr(dialog, "_on_accept", None) or getattr(dialog, "accept", None)
